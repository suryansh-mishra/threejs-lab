...
export class Earth {
  ...
  private prepareScene() {
    ...
    const earthMap = earthMapLoader.load('./assets/textures/earth-texture.jpg');
    const earthSpecMap = earthSpecMapLoader.load(
      './assets/textures/earth-spec.jpg'
    );
    const earthBumpMap = earthBumpMapLoader.load(
      './assets/textures/earth-bumps.jpg'
    );
    const earthLightMap = earthLightMapLoader.load(
      './assets/textures/earth-lights.jpg'
    );
    const earthCloudsMap = earthCloudsMapLoader.load(
      './assets/textures/earth-cloud-dark.jpg'
    );
